package com.usermanagementportal.exceptions;
...
public class ExceptionHandling implements ErrorController {
    ...
    /*
    If any of these exceptions fail catch, this is last place to go. The parent exception class.
    */
    ...
    //Trigger the 404 error page not found exception
    @RequestMapping(ERROR_PATH)
    public ResponseEntity<HttpResponse> pageNotFoundErrorException(){
    ...
    //Overriding the default Spring Whitelabel or error page.
    @Override
